...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\user\\Desktop\\psychopy lab\\stroop_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text = visual.TextStim(win=win, name='text',
        text='',
        font='Comic Sans',
        pos=(0, 0), draggable=False, height=0.05, wrapWidth=None, ori=1.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
        depth=0.0);
    ...
    trials = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('stroop task.xlsx'), 
        seed=None, 
    )
    ...
    for thisTrial in trials:
        ...
        while continueRoutine and routineTimer.getTime() < 0.35:
            ...
            if polygon.status == STARTED:
                ...
                if tThisFlipGlobal > polygon.tStartRefresh + .35-frameTolerance:
        ...
        continueRoutine = True
        # update component parameters for each repeat
        text.setColor(letterColor, colorSpace='rgb')
        text.setOri(orientation)
        text.setText(word)
